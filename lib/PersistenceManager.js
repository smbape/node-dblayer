...
var CompiledMapping, DeleteQuery, GenericUtil, InsertQuery, PRIMITIVE_TYPES, PersistenceManager, RowMap, SelectQuery, UpdateQuery, _, _addUpdateOrDeleteCondition, _addWhereCondition, _getInitializeCondition, assertValidModelInstance, async, isValidModelInstance, log4js, logger, semLib, squel,
...
SelectQuery = (function() {
  ...
  SelectQuery.prototype.toQueryString = function(rowMap) {
    rowMap || (rowMap = this.getRowMap());
    return rowMap.parse(this.toString());
  };
  ...
  SelectQuery.prototype.list = function(connector, callback) {
    ...
    rowMap = this.getRowMap();
    query = this.toQueryString(rowMap);
    pMgr = this.getManager();
    options = this.getOptions();
    connector.query(query, function(err, res) {
