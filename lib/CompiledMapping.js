...
(function() {
  var CompiledMapping, GenericUtil, Model, log4js, logger, modelId, _, _addConstraints, _addMixins, _addProperties, _resolve, _setConstructor,
  ...
  module.exports = CompiledMapping = (function() {
    function CompiledMapping(mapping) {
      var classDef, className, definition, prop, value, _i, _len, _ref, _ref1, _ref2;
      _ref = ['classes', 'resolved', 'unresolved', 'tables'];
      ...
      for (className in _ref1) {
        classDef = _ref1[className];
        _ref2 = classDef.properties;
        for (prop in _ref2) {
          value = _ref2[prop];
    ...
    CompiledMapping.prototype.getDefinition = function(className) {
      this.assertClassHasMapping(className);
      return _.cloneDeep(this.classes[className]);
    };
    ...
    CompiledMapping.prototype._addMixin = function(className, mixin) {
      var definition, dependencyClassName, index, mixinClassName, mixins, obj, parents, _i, _ref;
      definition = this.classes[className];
      mixins = definition.dependencies.mixins;
      mixinClassName = mixin.className;
      parents = [];
      for (index = _i = _ref = mixins.length - 1; _i >= 0; index = _i += -1) {
  ...
  _addProperties = function(classDef, rawProperties) {
    var err, handler, handlerType, handlers, prop, propDef, rawPropDef, _i, _len, _ref;
  ...
  _addMixins = function(compiled, classDef, rawDefinition, id, mapping) {
    var className, err, mixin, mixinDef, mixins, parents, prop, resolved, seenMixins, _i, _len, _mixin;
  ...
  _addConstraints = function(classDef, rawDefinition) {
    var ERR_CODE, constraint, constraints, err, index, prop, properties, rawConstraints, _i, _j, _len, _len1;
    ...
    ERR_CODE = 'CONSTRAINT';
    for (index = _i = 0, _len = rawConstraints.length; _i < _len; index = ++_i) {
