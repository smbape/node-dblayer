...
(function() {
  var PostgresClient, PostgresQueryStream, QueryStream, adapter, logger, pg, _,
  ...
  PostgresClient = (function(_super) {
    __extends(PostgresClient, _super);
  ...
  PostgresQueryStream = (function(_super) {
    __extends(PostgresQueryStream, _super);
