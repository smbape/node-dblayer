...
(function() {
  ...
  PostgresClient = (function(superClass) {
    ...
    PostgresClient.prototype.query = function(query, params, callback) {
      if ('string' === typeof query && query.match(/^\s*(?:insert|update|delete)\s+/i)) {
        return PostgresClient.__super__.query.call(this, query, params, callback);
      }
      return PostgresClient.__super__.query.call(this, new PostgresQueryStream(query, params, callback));
    };
  ...
  _.extend(adapter, {
    ...
    escape: function(value) {
      ...
      return PostgresClient.prototype.escapeLiteral(value);
    },
