...
(function() {
  var ArrayStream, EventEmitter, GenericUtil, MODES, SQLite3Connection, SQLite3Query, SQLite3Stream, adapter, log4js, logger, path, sqlite3, _,
  ...
  SQLite3Connection = (function(_super) {
    __extends(SQLite3Connection, _super);
  ...
  SQLite3Query = (function(_super) {
    __extends(SQLite3Query, _super);

    function SQLite3Query(args) {
      this.init.apply(this, args);
    }

    SQLite3Query.prototype.init = function(_at_text, values, callback) {
      this.text = _at_text;
  ...
  SQLite3Stream = (function(_super) {
    __extends(SQLite3Stream, _super);
    ...
    SQLite3Stream.prototype.init = function(_at_text, values, callback, done) {
      this.text = _at_text;
      if (Array.isArray(values)) {
        this.values = values;
      } else {
    ...
    SQLite3Stream.prototype._onData = function(row) {
      this.callback(row);
    };
