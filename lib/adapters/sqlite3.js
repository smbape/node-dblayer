...
var ArrayStream, EventEmitter, MODES, SQLite3Connection, SQLite3Query, SQLite3Stream, _, adapter, common, log4js, logger, path, sqlite3,
...
_.extend(adapter, {
  ...
  escapeId: function(value) {
    return common._escape(value, common._escapeConfigs[common.CONSTANTS.POSTGRES].id);
  },
  escape: function(value) {
    return common._escape(value, common._escapeConfigs[common.CONSTANTS.POSTGRES].literal);
  },
