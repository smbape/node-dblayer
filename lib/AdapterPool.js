...
var AdapterPool, GenericUtil, SemaphorePool, _, defaultOptions, internal, levelMap, log4js, logger, path, semLib,
    ...
    if (this._factory.min > this._created.length) {
      this.acquire((function(_this) {
        return function(err, client) {
          ...
          _this.release(client);
          _this._ensureMinimum();
        };
      })(this));
    }
  };
    ...
    AdapterPool.__super__.constructor.call(this, {
      ...
      create: (function(_this) {
        return function(callback) {
          logger.debug(_this._factory.name + " create", _this.id);
      ...
      destroy: (function(_this) {
        return function(client) {
          ...
          logger.debug(_this._factory.name + " destroy", _this.id);
