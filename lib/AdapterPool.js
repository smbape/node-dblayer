...
var AdapterPool, GenericUtil, _, defaultOptions, internal, levelMap, log4js, logger, path;
...
module.exports = AdapterPool = (function() {
  function AdapterPool(connectionUrl, options, next) {
    var GenericPool, auth, err, except, i, j, key, len, len1, method, parsed, pool, prop, ref, ref1, url;
    ...
    pool = this.pool = GenericPool.Pool({
