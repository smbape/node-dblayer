...
var GenericUtil, JOIN_FUNC, RowMap, STATIC, _, _coerce, _createModel, _createPlainObject, _getModelValue, _getPlainObjectValue, _handleRead, _readFields, _replaceField, _setModelValue, _setPlainObjectValue, fieldPattern, fieldPatternTest, log4js, logger, path, squel,
  slice = [].slice;
...
module.exports = RowMap = (function() {
  ...
  function RowMap(className1, manager, options1) {
  ...
  RowMap.prototype._getSetColumn = function(field) {
    var allAncestors, ancestors, i, id, index, info, len, prop;
  ...
  RowMap.prototype._getSetInfo = function(id, asIs) {
    var ancestors, availableProperty, definition, info, parentInfo, prop, propDef, ref;
    info = this._getInfo(id);
    if (info) {
      return info;
    }
...
_coerce = function(str) {
  if ('string' === typeof str) {
    return _replaceField(str, (function(_this) {
      return function(field) {
        return _this._getSetColumn(field);
      };
    })(this));
