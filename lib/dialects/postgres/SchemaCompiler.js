...
module.exports = PgSchemaCompiler = (function(superClass) {
  ...
  PgSchemaCompiler.prototype.dropColumn = function(tableName, column, options) {
    var LF, altersql, args, escapeId, indent, ref, words;
    options = _.defaults({}, options, this.options);
    ref = this, words = ref.words, escapeId = ref.escapeId, args = ref.args, indent = ref.indent, LF = ref.LF;
  ...
  PgSchemaCompiler.prototype.diffType = function(tableName, column, oldColumnSpec, newColumnSpec) {
    var LF, altersql, args, columnCompiler, columnId, escape, escapeId, indent, newModifier, newTypeString, oldModifier, oldTypeString, options, ref, spec, tablesql, words;
    options = _.defaults({}, options, this.options);
    ref = this, words = ref.words, escapeId = ref.escapeId, escape = ref.escape, columnCompiler = ref.columnCompiler, args = ref.args, indent = ref.indent, LF = ref.LF;
    args.table = tableName;
    args.column = column;
  ...
  PgSchemaCompiler.prototype.renameConstraint = function(tableName, oldName, newName, oldTableModel, options) {
    var altersql, escapeId, ref, words;
