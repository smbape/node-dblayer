...
SchemaCompiler.prototype.getDatabaseModel = function(pMgr, options) {
  var className, column, dbmodel, definition, foreignKey, i, index, indexKey, j, key, len, len1, mixin, name, names, parentDef, primaryKey, prop, propDef, propToColumn, properties, ref, ref1, ref2, ref3, ref4, ref5, tableModel, tableName, unique;
  dbmodel = {};
  ...
  for (className in ref) {
    ...
    for (index = i = 0, len = ref1.length; i < len; index = ++i) {
      ...
      column.nullable = false;
      ref2 = this.addForeignKeyConstraint('EXT', tableModel, mixin, parentDef, _.defaults({
        fkindex: false
